...
function Users_Registration() 
{
	...
	else
	{
		...
		$.ajax({
			...
			beforeSend: function() 
			{
				$("#signup_status").asp('<br clear="all"><div style="padding-left:115px;"><font style="font-family:Verdana, Geneva, sans-serif; font-size:12px; color:black;">Please wait</font> <img src="images/loadings.gif" alt="Loading...." align="absmiddle" title="Loading...."/></div><br clear="all">');
			},
			success: function(response)
			{window.location = "newuser.asp";
